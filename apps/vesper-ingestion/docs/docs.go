        ...
        "/api/v1/b2b/keys": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Session token (e.g. session_tenantID)",
                        "name": "Authorization",
                        "in": "header",
                        "required": true
                    },
        ...
        "/api/v1/support/telemetry/": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "API Key",
                        "name": "X-Sovereign-API-Key",
                        "in": "header",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Bundle ID of the mobile app",
                        "name": "X-Bundle-ID",
                        "in": "header",
                        "required": true
                    },
                    {
                        "description": "Binary telemetry payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Tenant identity missing",
                        "schema": {
                            "type": "string"
                        }
                    }
    ...
    "definitions": {
        ...
        "domain.Metric": {
            ...
            "properties": {
                ...
                "metric_type": {
                    "description": "1: Integrity, 2: Latency",
                    "type": "integer"
                },
                "timestamp": {
                    "type": "string"
